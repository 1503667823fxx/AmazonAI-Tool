   ...
   - 严禁品牌名。"""
    ...
    with st.expander("🛑 违禁词库 (已扩充)", expanded=False):
        forbidden_words = st.text_area(
            "严禁使用的词 (逗号分隔)", 
            value="Best Seller, No.1, Top rated, Free shipping, Guarantee, Warranty, Satisfaction, FDA approved, Anti-bacterial, Eco-friendly, Lowest Price, Discount, Sale, Cheap, Bonus, Gift, Prime, 100% Quality, High quality, Premium, Ultra, Super, Amazing, Unique, Perfect，Double, safe",
            height=150,
